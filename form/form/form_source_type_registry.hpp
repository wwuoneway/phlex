...
namespace form::experimental {
  ...
  using form_source_reader_fn = std::function<phlex::experimental::product_ptr(
  ...
  void register_form_product_cpp_type(std::string product_type)
  {
    ...
    register_form_product_type(
      ...
      [](form_reader_interface& reader,
        ...
        reader.read(creator, index_str, pb, runtime_product_type);
        if (!pb.data) {
